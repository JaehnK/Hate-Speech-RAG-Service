...
| 영향 문서 | `00_project_brief.md`, `01_user_scenarios.md`, `02_hld.md`, `03_data_model.md`, `04_pipeline_jobs.md`, `05_api_spec.md`, `06_report_spec.md`, `07_backend_design.md`, `08_mvp_plan.md`, `10_docker_environment.md`, `11_definition_corpus_targets.md` |
