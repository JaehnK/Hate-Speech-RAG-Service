...
from sqlalchemy import BigInteger, Boolean, DateTime, ForeignKey, Index, Integer, JSON, Numeric, String, Text, UniqueConstraint, Uuid
...
class AnalysisResultMixin:
    ...
    hate_type: Mapped[str | None] = mapped_column(String(64))
